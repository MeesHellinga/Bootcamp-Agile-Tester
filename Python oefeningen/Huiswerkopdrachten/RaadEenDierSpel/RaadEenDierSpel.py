# Het programma stelt een vraag
# Gebruiker antwoord ja of nee
# Het programma raad een diet adhv antwoorden
# Voorzie het programma van enkele vragen in dataset
# Indien het programma dier niet kan raden vraagt het om een extra vraag voor database
# Daardoor groeit de dataset
